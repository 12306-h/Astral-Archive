    ...
    <div class="main-content">
      ...
      <div class="sidebar">
        ...
        <div class="sidebar-nav">
          <button v-for="(item, index) in sidebarItems" :key="index" class="sidebar-item"
            :class="{ active: activeSection === item.id }" @click="setActiveSection(item.id)">
        ...
        <!-- Author Register Section -->
        <div class="author-register">
          <input v-model="authorName" placeholder="输入作者名" class="register-input" />
          <button @click="handleRegister" class="register-button">注册作者</button>
          <div class="register-msg" v-if="registerMsg">{{ registerMsg }}</div>
        </div>
      </div>
      ...
      <div class="content-area">
        <!-- My Posts Section -->
        <ScrollableContainer v-if="activeSection === 'mypost'" :totalItems="posts.length">
          <template #icon>
          ...
          <PostItem v-for="(post, index) in posts" :key="index" :title="post.title" :content="post.content"
            :time="post.time" @delete="deletePost(index)" />
        </ScrollableContainer>

        <!-- Assets Section -->
        <ScrollableContainer v-if="activeSection === 'assets'" :showTotal="false">
          <template #icon>
          ...
          <div class="assets-content">
            ...
            <div class="assets-detail-list">
              <AssetDetailItem v-for="(asset, index) in assetDetails" :key="index" :title="asset.title"
                :amount="asset.amount" @details="showAssetDetails(asset)" />
            </div>
          </div>
        </ScrollableContainer>

        <!-- Collection Section -->
        <ScrollableContainer v-if="activeSection === 'collection'" :totalItems="collections.length">
          <template #icon>
        ...
        <ScrollableContainer v-if="activeSection === 'notification'" :totalItems="notifications.length">
          <template #icon>
          ...
          <notificateComponent v-for="(notification, index) in notifications" :key="index" :type="notification.type"
            :avatar="notification.avatar" :content="notification.content" :comment="notification.comment" />
        </ScrollableContainer>

        <!-- Followers Section -->
        <ScrollableContainer v-if="activeSection === 'followers'" :totalItems="followers.length">
          <template #icon>
          ...
          <followerComponent v-for="(follower, index) in followers" :key="index" :avatar="follower.avatar"
            :name="follower.name" @visit-homepage="visitHomepage(follower.id)" />
        </ScrollableContainer>

        <!-- Following Section -->
        <ScrollableContainer v-if="activeSection === 'following'" :totalItems="following.length">
          <template #icon>
          ...
          <followerComponent v-for="(user, index) in following" :key="index" :avatar="user.avatar" :name="user.name"
    ...
    <div class="modal-overlay" v-if="showEditModal">
      <div class="edit-modal">
        ...
        <div class="modal-avatar-container">
          <img :src="editFormData.avatar" alt="User Avatar" class="modal-avatar" />
          <button class="upload-button" @click="triggerFileUpload">
            Upload
          </button>
          <input type="file" id="avatar-upload" ref="fileInput" @change="handleFileUpload" accept="image/*"
            style="display: none" />
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="username" v-model="editFormData.username" class="form-input" />
        </div>

        <div class="form-group">
          <label for="self-intro">自我介绍:</label>
          <textarea id="self-intro" v-model="editFormData.selfIntro" class="form-textarea"></textarea>
        </div>
...
const handleRegister = async () => {
  try {
    const { registerAuthor } = useAuthorManager();
    await registerAuthor(authorName.value);
